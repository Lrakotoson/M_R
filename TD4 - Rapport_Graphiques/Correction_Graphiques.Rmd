...
5.
```{r}
#si on n'utilise pas l'option error=TRUE, la compilation du document ne fonctionne pas
print(UnObjet)
```
...
```{r eval=FALSE}
etat2=read.table("donnees/etat2.csv", sep=",", header = TRUE) #!a personaliser le chemin
summary(etat2)# Toujours vérifier l'importation
```

```{r echo=FALSE}
setwd("~/Documents/cursuri+Td/2018-2019/TD-R/Application/donnees")
etat2=read.table("etat2.csv", sep=",", header = TRUE)
```
