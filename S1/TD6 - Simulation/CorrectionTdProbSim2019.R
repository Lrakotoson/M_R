...
# +
#3.
plot(x,dnorm(x),type="l",ylim=c(0,1),ylab = "",lwd=2)
lines(x,pnorm(x),col=2)
...
# l'estimatuer du max de vraisaimblance est donnée par $1/\bar{X_n} (\bar{X_n}$ est la moyenne empirique)
...
# 1.
# Soit X1,...,Xn,... v.a iid de moyenne $\mu$ et de variance $\sigma^2$ (sigma2 != 0). 
# Sn = X1+...Xn
# On a $$\frac{Sn - n\mu}{\sqrt{n\sigma^2}} ---> N(0,1)$$ (cvg en loi)
