...
## Modèle 5: endogénéité
Cette forte valeur de R2 peut cacher un problème d'endogénéité.

```{r}
iv <- ivreg(Life_Ladder ~ log(GDP_PPP) + Social_support + HALE_birth + 
    Generosity + Positive_affect + GINI_household | Social_support + HALE_birth + 
    Generosity + Positive_affect + GINI_household + Freedom + Negative_affect + Corruption, data = data)
